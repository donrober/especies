...
<body>
<form id="form1" name="form1" action="db_procmalestares.php" method="POST">
...
<input type="hidden" name="regTrataId" id="regTrataId" value="-1" />
...
<script language='javascript'>
	...
	{		
		document.getElementById('regTrataId').value = pIndex;
	...
	function editaTrata(pIndex)
	{
		...
		if (pIndex != -1)
		{
			...
			xmlhttp.open('POST', 'db_proctratamientos.php', true); 
	...
	function evalua_registro(pIndex)
	{
		...
		xmlhttp.open('POST', 'ref_cat_malestares.php', true); 
		xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
		xmlhttp.send(params); 
	...
	function carga_detalle(pIndex)
	{
		...
		xmlhttp.open('POST', 'ref_det_malestares.php', true); 
		xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
		xmlhttp.send(params); 
