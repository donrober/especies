<?php
	...
	function actualiza()
	{
		...
		echo "<script language='javascript'>top.document.location='cat_familias.php';</script>"; 
	}
	...
	function crea()
	{
		...
		$query = "insert into ".$cat_ref."(nombre, descripcion, IdOrden) ".
			"VALUES ".
			"('".$nombre."','".$descripcion."', '".$idOrden."')";
