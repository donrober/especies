<?php
	...
	function actualiza()
	{
		...
		if ($regId != "")
		{
			...
			$query = "update cat_soluciones set nombre = '".$nombre."', ".
				"descripcion = '".$descripcion."' ".
				"where IdSolucion = ".$regId;
		
			//Realizar una consulta MySQL
			$result = mysql_query($query) or die('Error al insertar en cat_soluciones: ' . mysql_error());
			$tratId = mysql_insert_id();

			$query = "update ".$cat_ref." set IdSolucion = ".
			"concat(IdSolucion, ',".$tratId."') where IdProblema = ".$regId;

			$result = mysql_query($query) or die('Error al actualizar en cat_problemas: ' . mysql_error());
	...
	function elimina()
	{
		...
		if ($regId != "")
		{
			...
			$query = "DELETE FROM cat_soluciones WHERE idSolucion = ".$regId;
	...
	function creaconmalestar()
	{
		...
		if ($regId != "")
		{
			...
			$query = "insert into cat_soluciones(nombre, descripcion) ".
				"VALUES ".
				"('".$nombre."','".$descripcion."')";
	...
	function crea()
	{
		...
		echo "<script language='javascript'>top.document.location='cat_soluciones.php';</script>";
	}
?>
