<?php
	...
	function actualiza()
	{
		...
		echo "<script language='javascript'>top.document.location='cat_especies.php';</script>"; 
	}
	...
	function crea()
	{
		...
		$query = "insert into ".$cat_ref."(nombre, descripcion, IdGenero) ".
			"VALUES ".
			"('".$nombre."','".$descripcion."', '".$idGenero."')";
