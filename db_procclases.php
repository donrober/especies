<?php
	...
	function actualiza()
	{
		...
		echo "<script language='javascript'>top.document.location='cat_clases.php';</script>"; 
	}
	...
	function crea()
	{
		...
		$query = "insert into ".$cat_ref."(nombre, descripcion, IdFilo) ".
			"VALUES ".
			"('".$nombre."','".$descripcion."', '".$idFilo."')";
