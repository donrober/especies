<?php
	...
	function actualiza()
	{
		...
		echo "<script language='javascript'>top.document.location='cat_filos.php';</script>"; 
	}
	...
	function crea()
	{
		...
		$query = "insert into ".$cat_ref."(nombre, descripcion, IdReino) ".
			"VALUES ".
			"('".$nombre."','".$descripcion."', '".$idReino."')";
