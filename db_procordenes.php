<?php
	...
	function actualiza()
	{
		...
		echo "<script language='javascript'>top.document.location='cat_ordenes.php';</script>"; 
	}
	...
	function crea()
	{
		...
		$query = "insert into ".$cat_ref."(nombre, descripcion, IdClase) ".
			"VALUES ".
			"('".$nombre."','".$descripcion."', '".$idClase."')";
