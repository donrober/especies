...
<body>
<form id="form1" name="form1" action="db_procreinos.php" method="POST">
	<div id='topNav' name='topNav'>
		<?php $link = new control_html();
			$link->control = "link";
			$link->nombrecontrol = "linkCuidados";
			$link->texto = "Cuidados";
			$link->winTarget = "_self";
			$link->link = "./cat_cuidados.php";
...
<script language='javascript'>
	function evalua_registro(pIndex)
	{
		...
		xmlhttp.open('POST', 'ref_cat_reinos.php', true); 
