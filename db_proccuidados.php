<?php
	...
	function actualiza()
	{
		...
		echo "<script language='javascript'>top.document.location='cat_cuidados.php';</script>"; 
	}
	...
	function crea()
	{
		...
		$query = "insert into ".$cat_ref."(nombre, descripcion, idusuario) ".
			"VALUES ".
